      ...
      <div className="container px-8 sm:px-0 py-14 mx-auto flex flex-wrap">
        {steps.map((step, index) => (
          <div key={index} className="flex relative py-8 sm:items-center md:w-2/3 mx-auto">
            ...
            <div className={`flex-shrink-0 w-6 h-6 rounded-full mt-10 sm:mt-0 items-center bg-primary-800 relative z-10`}></div>
            <div className="flex-grow md:pl-8 pl-6 flex sm:items-center items-start flex-col sm:flex-row">
              <div className="flex-shrink-0 w-24 h-24 bg-primary-800 text-primary-500 rounded-full inline-flex items-center justify-center">
                <step.icon className="w-12 h-12 hover:scale-125 hover:opacity-70 transition" />
              </div>
